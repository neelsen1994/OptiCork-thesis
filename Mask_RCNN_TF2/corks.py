"""
Mask R-CNN
Train on the Cork dataset and implement cork defect analysis.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 cork.py train --dataset=/path/to/cork/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 cork.py train --dataset=/path/to/cork/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 cork.py train --dataset=/path/to/cork/dataset --weights=imagenet

    # Apply color splash to an image
    python3 cork.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 cork.py splash --weights=last --video=<URL or path to file>
"""
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect cork defects.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/cork/dataset/",
                        help='Directory of the Cork dataset')
